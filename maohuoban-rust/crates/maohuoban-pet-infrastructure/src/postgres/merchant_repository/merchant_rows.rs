...
use maohuoban_pet_domain::pet::{
    ...
    MerchantStatusCount, MerchantType, MerchantVerificationStatus, PetBackgroundMediaKind,
    PetError, PetEvent, PetNeuterStatus, PetProfile, PetRelationship, PetRelationshipKind,
    PetRelationshipSourceKind, PetSex, PetSourceKind, PetSpecies,
};
